...
import * as LoginActionCreators from '../../actions/actions'
            ...
            <React.Fragment>
              ...
              <main className={classes.layout}>
                <Paper className={classes.paper}>
                  ...
                  {/* action = "http://localhost:6090/ahits/login" method = "post" */}
...
// let singin = connect(mapStateToProps, mapDispatchToProps)(SignIn);
